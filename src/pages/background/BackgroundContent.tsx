  ...
  return (
    <div className={`content-page ${isDarkMode ? "dark-mode" : "light-mode"}`}>
      ...
      <div className="nav-module">
        ...
        <button
          className={`nav-btn ${activeCategory === "自然" ? "active" : ""}`}
          onClick={() => setActiveCategory("自然")}
        >
          真人
        </button>
        <button
          className={`nav-btn ${activeCategory === "抽象" ? "active" : ""}`}
          onClick={() => setActiveCategory("抽象")}
        >
          动漫
        </button>
        <button
          className={`nav-btn ${activeCategory === "几何" ? "active" : ""}`}
          onClick={() => setActiveCategory("几何")}
        >
          插画
        </button>
        <button className="sort-btn" onClick={toggleSortOrder}>
