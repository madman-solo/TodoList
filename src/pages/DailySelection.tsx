...
//       if (startX - endX > 50 && activeIndex < dailyItems.length - 1) {
...
//       carouselRef.current?.removeEventListener("touchend", touchEndHandler);
//     };

//     carouselRef.current?.addEventListener("touchend", touchEndHandler);
//   };

//   // 处理点击评论
//   const handleCommentClick = () => {
//     navigate("/daily/comments");
//   };
